...
var MigrationHandler = /** @class */ (function () {
  ...
  MigrationHandler.prototype.migrateJsons = function (jsons, migrators) {
    var migratedJsons = jsons.map(function (json) {
      return migrators.reduce(function (acc, m) {
        return m.apply(acc);
      }, json);
    });
        ...
        switch (_e.label) {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              Promise.all(
                filePathAndJson_s.map(function (filePathAndJson) {
                  return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                      switch (_a.label) {
                        case 0:
                          return [
                            4 /*yield*/,
                            fs.writeFile(
                              filePathAndJson.filePath,
                              JSON.stringify(filePathAndJson.json, null, 2),
                              'utf8'
                            ),
                          ];
                        case 1:
