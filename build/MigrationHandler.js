...
var MigrationHandler = /** @class */ (function () {
     ...
     */
    MigrationHandler.prototype.migrateJsons = function (jsons, migrators) {
     ...
     * @param shouldLog
     */
    MigrationHandler.prototype.migrateFolder = function (folderPath, migrators, shouldLog) {
        if (shouldLog === void 0) { shouldLog = false; }
        return __awaiter(this, void 0, void 0, function () {
            var jsons, _a, _b, migratedJsons, filePathAndJson_s, _c, _d;
            var _this = this;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1: return [4 /*yield*/, _b.apply(_a, [(_e.sent()).map(function (fileName) { return __awaiter(_this, void 0, void 0, function () { var _a, _b; return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        _b = (_a = JSON).parse;
                                        return [4 /*yield*/, fs.readFile(path.join(folderPath, fileName), 'utf8')];
                                    case 1: return [2 /*return*/, _b.apply(_a, [_c.sent()])];
                                }
                            }); }); })])];
                    case 2:
                        jsons = _e.sent();
                        migratedJsons = this.migrateJsons(jsons, migrators);
                        if (shouldLog) {
                        ...
                        return [4 /*yield*/, fs.readdir(folderPath)];
                    case 3:
                        filePathAndJson_s = _d.apply(_c, [_e.sent(), migratedJsons, function (file, json) { return ({
                                json: json,
                                filePath: path.join(folderPath, file),
                            }); }]);
                        return [4 /*yield*/, Promise.all(filePathAndJson_s.map(function (filePathAndJson) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, fs.writeFile(filePathAndJson.filePath, JSON.stringify(filePathAndJson.json, null, 2), 'utf8')];
...
exports.migrationHandler = new MigrationHandler();
