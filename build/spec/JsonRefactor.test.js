...
var testData = [
    {
        ...
        testFn: function (input) { return JsonRefactor_1.jr.addField(input, 'j.i', { k: [{ x: 1 }, 1] }); },
        label: 'AddField',
        shouldRun: true,
    },
    {
        ...
        input: { status: 200, e: 'jones' },
        testFn: function (input) { return JsonRefactor_1.jr.setField(input, 'e', 300); },
        label: 'SetField',
        shouldRun: true,
    },
    {
        ...
        testFn: function (input) { return JsonRefactor_1.jr.removeField(input, 'j.i.k'); },
        label: 'RemoveField',
        shouldRun: true,
    },
    {
        expected: { status: 200, e: 'jones', j: { i: { k: [{ x: 1 }, 1] } } },
        input: { status: 200, e: 'jones', j: { i: { k: [{ x: 1 }, 1] } } },
        testFn: function (input) { return JsonRefactor_1.jr.copy(input); },
        label: 'Copy',
        shouldRun: true,
    },
    {
        ...
        testFn: function (input) { return JsonRefactor_1.jr.sameKeys(input.json1, input.json2); },
    ...
    },
    {
        ...
        testFn: function (input) { return JsonRefactor_1.jr.isSubset(input.json1, input.json2); },
    ...
    },
    {
        ...
        testFn: function (input) { return JsonRefactor_1.jr.isSubsetKeys(input.json1, input.json2); },
    ...
    },
    {
        ...
        testFn: function (input) { return JsonRefactor_1.jr.containSameElements(input.array1, input.array2); },
    ...
    },
    {
        expected: { x: 1 },
        input: { x: 1, y: 2, z: 3 },
        testFn: function (input) { return JsonRefactor_1.jr.subJsonExcept(input, ['y', 'z']); },
        label: 'subJsonExcept',
        shouldRun: true,
    },
    {
        expected: { y: 2, z: 3 },
        input: { x: 1, y: 2, z: 3 },
        testFn: function (input) { return JsonRefactor_1.jr.subJson(input, ['y', 'z']); },
        label: 'subJson',
        shouldRun: true,
    },
    {
        ...
        testFn: function (input) {
            return JsonRefactor_1.jr.isSubsetSpecialCases(input.json1, input.json2, ['x1', 'y'], [function (sub, sup) { return _.isEqual(sub.toLowerCase(), sup.toLowerCase()); }, function (sub, sup) { return JsonRefactor_1.jr.sameKeys(sub, sup); }], ['x', 'y']);
        },
