...
const testData: testTools.testInput[] = [
  ...
  },
  {
    ...
    testFn: input => jr.isSubset(input.json1, input.json2),
  ...
  },
  {
    ...
    testFn: input => jr.isSubsetKeys(input.json1, input.json2),
  ...
  },
  {
    ...
    testFn: input => jr.containSameElements(input.array1, input.array2),
  ...
  },
  {
    ...
    testFn: input => {
      ...
      return jr.containSameElements(actual, expected);
    },
    label: 'toKeyValArray',
    shouldRun: true,
  },
